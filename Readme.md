...
Konfigurasi Hardware: Rakit sensor dan buzzer ke pin ESP32 sesuai panduan. Pastikan rangkaian voltage divider terpasang dengan benar untuk sensor 5V.

Setup Cloud: * Buat database di Supabase dan jalankan script SQL untuk membuat tabel.

Siapkan workflow di n8n untuk menangkap Webhook dari ESP32.

Frontend: Salin kode index.html dan hubungkan dengan Project URL serta anon key Supabase Anda.

Monitoring: Pastikan ESP32 terhubung ke WiFi lokal agar dapat mengirimkan data ke Webhook n8n.

⚠️ Catatan Keamanan

API Keys: Jangan pernah menyertakan service_role key Supabase dalam kode frontend Anda. Gunakan hanya anon public key.

Koneksi: Pastikan ESP32 berada dalam jangkauan WiFi yang stabil agar data tidak putus.

Troubleshooting: Jika data tidak muncul, periksa log di n8n dan pastikan tabel Supabase Anda memiliki kolom yang sesuai.

Proyek ini merupakan implementasi nyata dari konsep IoT untuk mitigasi bencana berbasis data.
